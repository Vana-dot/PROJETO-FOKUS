...
const iconPlayOuPausar = document.querySelector('.app__card-primary-butto-icon');
...
const audioPause = new Audio('./assets/sons/pause.mp3');
...
function iniciarOuPausar(){
    ...
    iconPlayOuPausar.setAttribute('src','./assets/imagens/pause.png');
}

function zerar(){
    clearInterval(intervaloId);
    iniciarOuPausarBt.textContent = "Começar";
    iconPlayOuPausar.setAttribute('src','./assets/imagens/play_arrow.png');
    intervaloId = null;
}
